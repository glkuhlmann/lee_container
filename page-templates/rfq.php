...
<div class="container">
	<div class="row">
		<div class="col-sm-12 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3 kitchen-sink text-center">
		...
		<div id="gravity" class="col-sm-12 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3 mb-40">
			<div class="inner">
				<div class="band kitchen-sink">
					<h2>Application for Quotation</h2>
